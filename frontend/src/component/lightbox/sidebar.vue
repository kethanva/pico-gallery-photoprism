      ...
      <v-list nav slim tile density="compact" bg-color="background" class="metadata__list mt-1">
        ...
        >
          <v-textarea
            ...
            @blur="onInlineFieldBlur"
          ></v-textarea>
          <div v-else-if="model.Caption" v-sanitize="captionHtml" class="text-body-2 meta-caption meta-scrollable text-html"></div>
          ...
          <template v-for="f in detailsFields" :key="f.key">
            ...
            >
              <v-textarea
                ...
                @blur="onInlineFieldBlur"
              ></v-textarea>
              <div v-else-if="f.display === 'html' && fieldHtml(f)" v-sanitize="fieldHtml(f)" class="text-body-2 meta-scrollable text-html" :class="`meta-${f.key}`"></div>
